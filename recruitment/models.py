...
from Mibs_audit.models import MibsAuditLog, MibsAuditInfo
from Mibs_audit.methods import get_diff
from Mibs.decorators import logger
...
class SurveyTemplate(MibsModel):
    """
...
class Stage(MibsModel):
    ...
    objects = MibsCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectedCandidate(MibsModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(MibsModel):
    """
    ...
    objects = MibsCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(MibsModel):
    """
...
class RecruitmentSurveyAnswer(MibsModel):
    """
...
class RecruitmentMailTemplate(MibsModel):
...
class SkillZoneCandidate(MibsModel):
    """
...
class CandidateRating(MibsModel):
...
class RecruitmentGeneralSetting(MibsModel):
    """
