...
from Mibs_audit.models import MibsAuditInfo, MibsAuditLog
from base.Mibs_company_manager import MibsCompanyManager
...
class JobPosition(MibsModel):
    ...
    objects = MibsCompanyManager("department_id__company_id")
...
class JobRole(MibsModel):
    ...
    objects = MibsCompanyManager("job_position_id__department_id__company_id")
...
class RotatingWorkType(MibsModel):
    """
    ...
    objects = MibsCompanyManager("employee_id__employee_work_info__company_id")
...
class RotatingWorkTypeAssign(MibsModel):
    """
...
class EmployeeShift(MibsModel):
    ...
    objects = MibsCompanyManager("employee_shift__company_id")
...
class EmployeeShiftSchedule(MibsModel):
    """
    ...
    objects = MibsCompanyManager("shift_id__employee_shift__company_id")
...
class RotatingShiftAssign(MibsModel):
    """
...
class WorkTypeRequest(MibsModel):
    """
...
class WorkTypeRequestComment(MibsModel):
    """
...
class ShiftRequestComment(MibsModel):
    """
...
class Tags(MibsModel):
    title = models.CharField(max_length=30)
    color = models.CharField(max_length=30)
    company_id = models.ForeignKey(
        Company, null=True, editable=False, on_delete=models.PROTECT
    )
    objects = MibsCompanyManager(related_company_field="company_id")

    def __str__(self):
        return self.title


class DynamicEmailConfiguration(MibsModel):
    """
...
class MultipleApprovalCondition(MibsModel):
...
class AnnouncementComment(MibsModel):
    """
...
class DashboardEmployeeCharts(MibsModel):
    from employee.models import Employee
