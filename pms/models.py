...
class KeyResult(MibsModel):
    ...
    history = MibsAuditLog(bases=[MibsAuditInfo])
...
class EmployeeObjective(MibsModel):
    ...
    history = MibsAuditLog(bases=[MibsAuditInfo], related_name="history_set")
...
class Comment(models.Model):
    ...
    history = MibsAuditLog(excluded_fields=["comment"], bases=[MibsAuditInfo])
    objects = MibsCompanyManager(
...
class QuestionTemplate(MibsModel):
...
class Question(MibsModel):
    ...
    objects = MibsCompanyManager("template_id__company_id")

    def __str__(self):
        return self.question


class QuestionOptions(MibsModel):
    ...
    objects = MibsCompanyManager("question_id__template_id__company_id")


class Feedback(MibsModel):
