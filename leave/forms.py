"""
This module provides Mibs ModelForms for creating and managing leave-related data,
...
from Mibs_widgets.forms import MibsForm, MibsModelForm
from Mibs_widgets.widgets.Mibs_multi_select_field import MibsMultiSelectField
from Mibs_widgets.widgets.select_widgets import MibsMultiSelectWidget
...
class LeaveOneAssignForm(MibsModelForm):
    """
    ...
    Attributes:
        - employee_id: A MibsMultiSelectField representing the employee to assign leave to.
    """

    employee_id = MibsMultiSelectField(
        queryset=Employee.objects.all(),
        widget=MibsMultiSelectWidget(
...
class AssignLeaveForm(MibsForm):
    """
    Form for Payslip
    """
