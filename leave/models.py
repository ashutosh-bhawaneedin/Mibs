...
class AvailableLeave(MibsModel):
...
class LeaverequestComment(MibsModel):
    """
...
class LeaveAllocationRequest(MibsModel):
    leave_type_id = models.ForeignKey(
...
class LeaveallocationrequestComment(MibsModel):
    """
