...
class Asset(MibsModel):
    ...
    objects = MibsCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(MibsModel):
...
class AssetAssignment(MibsModel):
    ...
    objects = MibsCompanyManager("asset_id__asset_lot_number_id__company_id")
