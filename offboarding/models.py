...
class OffboardingStage(MibsModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(MibsModel):
    """
...
class OffboardingEmployee(MibsModel):
    """
...
class ResignationLetter(MibsModel):
    """
...
class OffboardingTask(MibsModel):
    """
...
class OffboardingNote(MibsModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(MibsModel):
    """
