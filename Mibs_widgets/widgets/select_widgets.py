...
This module is used to write Mibs form select widgets
"""
...
class MibsMultiSelectWidget(forms.Widget):
    """
    MibsMultiSelectWidget
    """
    ...
    template_name = "Mibs_widgets/Mibs_multiselect_widget.html"
