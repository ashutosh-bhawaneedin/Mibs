...
class AttendanceActivity(MibsModel):
    """
...
class AttendanceRequestFile(MibsModel):
    file = models.FileField(upload_to="attendance/request_files")


class AttendanceRequestComment(MibsModel):
    """
...
class AttendanceOverTime(MibsModel):
    """
...
class AttendanceLateComeEarlyOut(MibsModel):
    """
...
class AttendanceValidationCondition(MibsModel):
    """
...
class PenaltyAccount(MibsModel):
    """
...
class AttendanceGeneralSetting(MibsModel):
    """
