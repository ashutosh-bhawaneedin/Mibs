...
class OnboardingStage(MibsModel):
    """
    ...
    objects = MibsCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(MibsModel):
    """
    ...
    objects = MibsCompanyManager("stage_id__recruitment_id__company_id")

    def __str__(self):
        return f"{self.task_title}"


class CandidateStage(MibsModel):
    """
    ...
    objects = MibsCompanyManager("candidate_id__recruitment_id__company_id")
...
class OnboardingPortal(MibsModel):
    """
