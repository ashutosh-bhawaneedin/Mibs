...
from Mibs_audit.models import AccountBlockUnblock
...
from Mibs_documents.forms import (
    DocumentForm,
    DocumentRejectForm,
    DocumentRequestForm,
    DocumentUpdateForm,
...
@login_required
@manager_can_enter("Mibs_documents.view_documentrequests")
def document_request_view(request):
    ...
    documents = filtersubordinates(
        request=request,
        perm="Mibs_documents.view_documentrequests",
        queryset=documents,
    )
...
@login_required
@manager_can_enter("Mibs_documents.add_documentrequests")
def document_request_create(request):
    ...
    form = choosesubordinates(request, form, "Mibs_documents.add_documentrequest")
    if request.method == "POST":
        form = DocumentRequestForm(request.POST)
        form = choosesubordinates(
            request, form, "Mibs_documents.add_documentrequest"
        )
        if form.is_valid():
            form = form.save()
...
@login_required
@manager_can_enter("Mibs_documents.change_documentrequests")
...
@login_required
@owner_can_enter("Mibs_documents.view_document", Employee)
...
@login_required
@owner_can_enter("Mibs_documents.add_document", Employee)
...
@login_required
@manager_can_enter("Mibs_documents.add_document")
