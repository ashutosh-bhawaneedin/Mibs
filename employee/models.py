...
class EmployeeBankDetails(MibsModel):
    """
...
class PolicyMultipleFile(MibsModel):
    """
...
class DisciplinaryAction(MibsModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(MibsModel):
    """
